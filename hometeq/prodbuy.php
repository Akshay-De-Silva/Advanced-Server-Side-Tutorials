...
while ($arrayp=mysqli_fetch_array($exeSQL))
{
    ...
    echo "<p><i>".$arrayp['prodDescripLong']."</i><br><br>";
    echo "<p><b>&nbsp&nbsp&nbsp&pound".$arrayp['prodPrice']."</b><br><br>";
    echo "<p>&nbsp&nbsp&nbspLeft in stock: ".$arrayp['prodQuantity']."</p><br>";

    echo "<p>&nbsp&nbsp&nbspNumber to be purchased: ";

    //create form made of one text field and one button for user to enter quantity
    //the value entered in the form will be posted to the basket.php to be processed
    echo "<form action=basket.php method=post>";
    //echo "&nbsp&nbsp&nbsp<input type=text name=p_quantity size=5 maxlength=3>";
